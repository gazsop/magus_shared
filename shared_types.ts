...
export namespace Application {
  ...
  export enum REQUEST_CONTROLLER {
    USERS = "/users",
    REST = "/rest",
...
export namespace Adventure {
  export type TWorldDateTime = number; // epoch ms; format only at UI boundary
  ...
  interface IAdventure {
    ...
    json: {
      name: string;
      worldDateStart?: TWorldDateTime;
      worldDateCurrent?: TWorldDateTime;
    };
  }
...
export namespace Character {
  ...
  export type TCharacterServer = {
    ...
    hash: string;
    json: TCharacter;
    computed?: TComputedCharacter;
  };

  export type TValueModifier = {
    flat?: number;
    percent?: number;
  };

  export type TComputedCharacter = {
    hm: THm;
    primaryStats: TPrimaryStat[];
    secondaryStats: TSecondaryStat[];
    resource: TResource;
  ...
  export type TClass = {
    ...
    modifiers: {
      ...
      secondaryStats: TSecondaryStat[];
      secondaryStatScalings: TSecondaryStat[];
      initialSecondarySkillPoints: number;
      secondarySkillPointsPerLvl: number;
      hm: THm;
      hmPlus: TScaling;
      resource: TResourceAbilities;
    };
  ...
  export type TResource = {
    ...
    abilities: TResourceAbilities;
  };

  export type TAuraModifier = {
    hm?: Partial<Record<keyof THm, TValueModifier | number>>;
    primaryStats?: Array<{
      name: PRIMARY_STATS;
      flat?: number;
      percent?: number;
    ...
    resource?: {
      health?: Partial<
        Record<"maxHp" | "currentHp" | "maxEp" | "currentEp", TValueModifier | number>
      >;
      abilities?: Partial<Record<"max" | "current", TValueModifier | number>>;
    };
  };
  ...
  export type TAura = {
    ...
    name: string;
    description: string;
    effect: Spell.TSpellEffect[];
    color: string;
    manual: boolean;
    modifiers?: TAuraModifier[];
  };

  export type TDamageLogEntry = {
    id: string;
    time: number;
    hpChange: number;
    epChange: number;
  ...
  export type TResourceAbilities = {
      name: RESOURCE_TYPE;
      current: number;
      max: number;
      regenPerRound: Adventure.TRollElements;
  ...
  export namespace Item {
    ...
    export type TItemAura = {
      description: string;
      effect: Character.Spell.TSpellEffect[];
      applyWhen?: TItemAuraApplyWhen;
    ...
    export type TItem = {
      ...
      effects?: {
        ...
        hm?: Partial<
          Record<keyof Character.THm, Character.TValueModifier | number>
        >;
        secondaryStats?: Array<{
          id: string;
          flat?: number;
        ...
        resource?: {
          health?: Partial<
            Record<
              "maxHp" | "currentHp" | "maxEp" | "currentEp",
              Character.TValueModifier | number
            >
          >;
          abilities?: Partial<
            Record<"max" | "current", Character.TValueModifier | number>
          >;
        };
    ...
    export type TBagState = "equipped" | "stored";

    export type TBagInstance = {
      id: string;
      state: TBagState;
      size: TBackpackSize;
      maxSlots: number;
      aura?: Character.TAura["effect"] | null;
    };
...
export namespace Vendor {
  ...
  export type TVendorRuntimeItem = TVendorItem & {
    remainingStock: number;
    listedPriceCopper: number;
  };

  export type TVendorState = {
    enabled: boolean;
    advId: string;
    ...
    sellRate: number;
    buyRate: number;
    items: TVendorRuntimeItem[];
    pendingTrades: TVendorTrade[];
  };

  export type TVendorTradeType = "buy" | "sell";
  export type TVendorTradeStatus = "pending" | "accepted" | "rejected";

  export type TVendorTrade = {
    id: string;
    advId: string;
    uid: string;
    type: TVendorTradeType;
    status: TVendorTradeStatus;
    createdAt: number;
    item: Character.Item.TItem;
    vendorItemId?: string;
    source?: {
